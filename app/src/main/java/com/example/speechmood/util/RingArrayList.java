// Source: https://github.com/osaukh/mobile_computing_lab/blob/master/code/SpeechProcessing/app/src/main/java/com/ahinea/speechprocessing/RingArrayList.java

package com.example.speechmood.util;
...
public class RingArrayList<E> extends AbstractList<E> implements RandomAccess {
    ...
    public RingArrayList(int capacity) {
        ...
        ringBuffer = new ArrayList<E>(Collections.nCopies(capacity + 1, null)); // head index always point to empty position (+1)
        size = 0;
        head = 0;
    }
